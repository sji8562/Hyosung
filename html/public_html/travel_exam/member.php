...
function idcheck(){
  ...
  window.open("idcheck.php?id="+frm1.id.value,"zzz","width=400,height=200");
...
<div id="wrap">
    ...
    <tr>
        ...
        <td>
          <input type="password" name="pw1" ><font color="red">(6자리이상 입력!)</font>
        </td>
    ...
    <tr>
        ...
        <td>
          <input type="text" name="hp1" size="5" maxlength="3">-<input type="text" name="hp2"size="5" maxlength="4">-<input type="text" name="hp3" size="5" maxlength="4">
        </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        ...
        <input type="checkbox" name="hobby5" value="음악">음
      </td>
    </tr>
    <tr>
      <td align=right>남기는 말
      </td>
      <td>
