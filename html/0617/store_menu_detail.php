...
<?php } ?>
      ...
      <div class="menu_detail">
        <form name="frmMenudetail" method="post" action="store_menu_detail_ok.php?storeNo=<?php echo $storeNo ?>">
        ...
        <table class="table1" style="width:300px">
          ...
          <tr>
            <td colspan="2" align="center"><img src="store_menu/1.jpg" width="200" height="200"></td>
          </tr>
          <?php
           ...
           <tr>
             ...
             <input type="hidden" name="pno" value="<?php echo $rowMenudetail["pno"] ?>">
           </tr>
          <tr>
            <td colspan="2" align="center" name="fdname"><?php echo $rowMenudetail["name"]; ?></td>
          </tr>
          <tr>
            <td colspan="2" align="center" name="fprice"><?php echo $rowMenudetail["price"] ?></td>
          </tr>
          <tr>
            <td colspan="2" align="center" name="smemo"><?php echo $rowMenudetail["smemo"] ?></td>
          </tr>
          <tr>
