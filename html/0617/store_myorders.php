...
<?php } ?>
      ...
      <?php
      $querymanager="select * from store where no=$sno";
      $rsmanager=mysqli_query($conn,$querymanager);
      $rowmanager=mysqli_fetch_array($rsmanager);
      ...
      <form class="frm_orders" action="store_myorders_ok.php" method="post">
        ...
        <table class="table1" style="width:500px">
          ...
          <tr>
            ...
            <input type="hidden" name="manager" value="<?php echo $rowmanager["manager"] ?>">
            <input type="hidden" name="storeno" value="<?php echo $rowmanager["no"] ?>">
          </tr>
      <?php } ?>
          <tr>
