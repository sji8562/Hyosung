...
<body>
  ...
  <tr>
      ...
      <img src="images/store/<?php echo $rowStoreInfo["pic"] ?>" style="width:400px;height:300px;">
      </td>
    </tr>
    <tr>
    <td align="left" colspan="2" style="font-size:3em;font-weight:bold"><?php echo $storeName; ?></td>
    </tr>
    <tr>
      <td align="left" style="height:5px">주소</td>
      <td align="left" style="height:5px"><?php echo $storeAddr; ?></td>
    </tr>
    <tr>
      <td align="left" style="height:5px">전화번호</td>
      <td align="left" style="height:5px"><?php echo $storeTel; ?></td>
    </tr>
    <tr>
      <td align="left" colspan="2"><?php echo $storeMemo; ?></td>
    </tr>
    </table>
    ...
    <tr>
      ...
      <img src="<?php echo "images/".$bigTypeNo."/".$smallType."/".$rowStoresubMenu["pic"]; ?>" style="width:150px;height:80px;"></a></td>
