<?php
  ...
  $querystorecart="select * from cart where id=$id";
  $rsstorecart=mysqli_query($conn,$querycart);
  $rowstorecart=mysqli_fetch_array($rsstorecart);
  ?>
<!DOCTYPE html>
...
<?php } ?>
      ...
      <div class="menu_detail">
        <form name="frm1" method="post" action="store_myorders.php?id=<?php echo $id ?> &sno=<?php echo $rowstorecart["sno"] ?>">
        ...
        <tr>
          ...
          <tr>
            ...
            <input type="hidden" name="sno" value="<?php echo $rowcart["sno"] ?>">
          </tr>
          <?php } ?>
        <tr>
