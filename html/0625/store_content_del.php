...
<body>
  ...
  <table class="table5">
    <?php
     ...
     ?>
  <tr>
    <th colspan="5" align="center"><?php echo $rowStore["store_name"] ?></th>
  </tr>
  <tr>
    <td>메뉴명</td>
    <td>가격</td>
  ...
  <tr>
    ...
    <td>
      <img src="images/<?php echo $bigTypeNo."/".$smallTypeNo."/".$storeNo."/".$pic;?>">
    </td>
    <td>
      <input type="button" value="삭제" onclick="location.href='store_content_del_ok.php?sno=<?php echo $no; ?>&storeNo=<?php echo $storeNo; ?>&smallTypeNo=<?php echo $smallTypeNo; ?>&bigTypeNo=<?php echo $bigTypeNo; ?>&pic=<?php echo $pic; ?>'" class="bt1">
    </td>
  </tr>
  <?php } ?>
  </table>
